...
envg$EXPENV$exp_dir <- "~/buckets/b1/expw_competencia_3_NEW_LM_2/"
envg$EXPENV$wf_dir <- "~/buckets/b1/flow_competencia_3_NEW_LM_2/"
...
HT_tuning_semillerio <- function( pinputexps, semillerio, bo_iteraciones, bypass=FALSE)
{
  ...
  param_local$meta$script <- "/src/wf-etapas/2212_HT_lightgbm_SEMI.r"
...
wf_SEMI_1122 <- function( pnombrewf )
{
