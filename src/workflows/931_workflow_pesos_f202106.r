...
envg$EXPENV$exp_dir <- "~/buckets/b1/expw_Pesos/"
envg$EXPENV$wf_dir <- "~/buckets/b1/flow_pesos/"
...
TS_strategy_base8 <- function( pinputexps )
{
  ...
  param_local$meta$script <- "/src/wf-etapas/z2102_TS_training_strategy.r"
...
HT_tuning_base <- function( pinputexps, bo_iteraciones, bypass=FALSE)
{
  ...
  param_local$meta$script <- "/src/wf-etapas/z2202_HT_lightgbm_gan.r"
...
FM_final_models_lightgbm <- function( pinputexps, ranks, qsemillas )
{
  ...
  param_local$meta$script <- "/src/wf-etapas/z2302_FM_final_models_lightgbm.r"
...
SC_scoring <- function( pinputexps )
{
  ...
  param_local$meta$script <- "/src/wf-etapas/z2402_SC_scoring_lightgbm.r"
...
wf_prueba_1<- function( pnombrewf )
{
