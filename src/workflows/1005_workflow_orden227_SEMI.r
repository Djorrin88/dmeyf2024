...
envg$EXPENV$exp_dir <- "~/buckets/b1/expw227_sin_3_4_01_RF/"
envg$EXPENV$wf_dir <- "~/buckets/b1/flow227_sin_3_4_01_RF/"
...
CA_catastrophe_base <- function( pinputexps, metodo )
{
  ...
  param_local$atributos_eliminar <- c( "tmobile_app", "cmobile_app_trx","cprestamos_personales","mprestamos_personales") #, "Visa_mlimitecompra" )
  param_local$semilla <- NULL  # no usa semilla, es deterministico
