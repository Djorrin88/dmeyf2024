...
envg$EXPENV$exp_dir <- "~/buckets/b1/expw_colaborativo_exp5/"
envg$EXPENV$wf_dir <- "~/buckets/b1/flow_colaborativo_exp5/"
...
FEintra_manual_base <- function( pinputexps )
{
  ...
  param_local$meta$script <- "/src/wf-etapas/1301_FE_intrames_manual_exp5.r"
...
SC_scoring <- function( pinputexps )
{
  ...
  param_local$meta$script <- "/src/wf-etapas/2401_SC_scoring_lightgbm_exp.r"
...
wf_junio_exp5 <- function( pnombrewf )
{
