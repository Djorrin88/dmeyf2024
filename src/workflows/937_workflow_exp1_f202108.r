...
envg$EXPENV$exp_dir <- "~/buckets/b1/expw_colaborativo_exp1_08/"
envg$EXPENV$wf_dir <- "~/buckets/b1/flow_colaborativo_exp1_08/"
...
)
{
  ...
  param_local$meta$script <- "/src/wf-etapas/1311_FE_rfatributes_exp1.r"
...
TS_strategy_base6 <- function( pinputexps )
{
  ...
  param_local$final_train$training <- c(202106,202105,202104, 202103, 202102,
    202101, 202012, 202011, 202010, 202009, 202008, 202007, 202005,
    202004, 202003, 202002, 202001, 201912)


  param_local$train$training <- c(202104, 202103,202102, 202101, 202012,
    202111, 202010, 202009,  202008, 202007, 202005,
...
wf_junio_exp1 <- function( pnombrewf )
{
