...
envg$EXPENV$exp_dir <- "~/buckets/b1/expw_colaborativo_exp6/"
envg$EXPENV$wf_dir <- "~/buckets/b1/flow_colaborativo_exp6/"
...
FEintra_manual_base <- function( pinputexps )
{
  ...
  param_local$meta$script <- "/src/wf-etapas/1301_FE_intrames_manual_exp6.r"
