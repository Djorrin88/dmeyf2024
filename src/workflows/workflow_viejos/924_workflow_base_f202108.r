...
envg$EXPENV$semilla_primigenia <- 571741 
...
wf_base_sin_prestamo_personal<- function( pnombrewf )
{
  param_local <- exp_wf_init( pnombrewf ) # linea workflow inicial fija

  # Etapa especificacion dataset de la Segunda Competencia Kaggle
  DT_incorporar_dataset( "~/buckets/b1/datasets/competencia_02_correcto_sin_prestamos_personales.csv.gz") #gs://jorrin1493/datasets/competencia_02_correcto_sin_prestamos_personales.csv.gz
