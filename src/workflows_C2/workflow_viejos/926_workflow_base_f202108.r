...
TS_strategy_base8 <- function( pinputexps )
{
  ...
  param_local$final_train$training <- c(202105, 202104, 202103,
    202005, 202004, 202003,201905,201904,201903)


  param_local$train$training <- c(202104, 202103, 202005,
    202004, 202003, 201905,201904,201903)
  param_local$train$validation <- c(202105)
...
wf_estacionalidad<- function( pnombrewf )
{
